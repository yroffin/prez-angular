 ...
 */
public class PrezTokenValidationFilter implements Filter {
	 ...
	 * @param excludes 
	 */
    public PrezTokenValidationFilter(final Config config, final String clientName, final String authorizerName, String[] excludes) {
        this.config = config;
